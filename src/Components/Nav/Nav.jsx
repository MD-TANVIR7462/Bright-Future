...
const Nav = () => {
   return (
      <div >
         <div className="navbar  bg-indigo-50 px-2 md:px-28  h-24  md:h-36 ">

<img src="https://i.ibb.co/PtCmmLp/Vector.png "  className='w-24 h-16  md:w-32 md:h-24 absolute   top-8  md:top-12 left-0 ' alt="" />         
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 font-semibold">
              <li><NavLink to={'/'} className={  ({ isActive }) => isActive ? 'text-pink-900 hidden' : 'text-black pl-4'}> <FontAwesomeIcon icon={faHome} />  Home</NavLink ></li>
              <li tabIndex={0}>
        ...
        <div className="navbar-center hidden lg:flex text-lg ">
          <ul className="menu menu-horizontal  font-bold mx-5">
            <NavLink to={'/'} className={({ isActive }) => isActive ? ' text-pink-900 mr-5 hidden' : 'text-black mr-5'}><FontAwesomeIcon icon={faHome} /> Home</NavLink>
...
<img src="https://i.ibb.co/16D27xX/Vector-1.png "  className='w-24 h-16  md:w-32 md:h-24 absolute   top-0  md:top-0 right-0 ' alt="" />  
